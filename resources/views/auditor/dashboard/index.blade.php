...
@section('content')
    <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <x-breadcrumb :items="[['label' => 'Dashboard', 'url' => route('auditor.dashboard.index')]]" />
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-200">Dashboard</h1>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-200 py-1">Hai User, Selamat Datang di Dashboard Auditor!</h1>
