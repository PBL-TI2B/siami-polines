        ...
        <div class="flex flex-row gap-5">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-8 w-2/3">
                ...
                rounded-full -start-4 ring-4 ring-white dark:ring-gray-900">
                        ...
                        @if($status == 6)
                        <a href="{{ route('auditor.laporan.index', ['auditingId' => $auditing->auditing_id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Step details here</a>
                        @endif
                    </li>
                    {{-- Closing Audit --}}
                    <li class="ms-6">
