        ...
        document.addEventListener("DOMContentLoaded", async function() {
            ...
            try {
                ...
                if (!result.data || !Array.isArray(result.data) || result.data.length === 0) {
                    tableBody.innerHTML =
                        `<tr><td colspan="9" class="py-6 text-center text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700">${'Tidak ada data audit untuk periode ini.'}</td></tr>`; // Tambahkan border juga di sini
                ...
                audits.forEach((item, index) => {
                    ...
                    const buttonClasses =
                        "text-sm font-medium rounded-lg px-4 py-2 flex items-center justify-center transition-all duration-200 text-white bg-sky-800 hover:bg-sky-900 focus:ring-4 focus:ring-sky-300 dark:focus:ring-sky-600";
