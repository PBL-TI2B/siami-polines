...
@section('title', 'Data Instrumen Unit Kerja')
...
@section('content')
    <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        ...
        <h1 class="mb-6 text-2xl font-semibold text-gray-900 dark:text-gray-200">
            ...
            {{ $audit['unit_kerja']['nama_unit_kerja'] ?? 'Unit Kerja' }}
        </h1>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const openModal = (isEdit, setInstrumenId, response = {}, instrumen = {}) => {
                ...
                modalTitle.textContent = isEdit ? 'Edit Jawaban Instrumen' : 'Jawab Instrumen Unit Kerja';
            ...
            const renderTable = (page = 1) => {
                ...
                if (paginatedData.length === 0) {
                    tableBody.innerHTML =
                        `<tr><td colspan="8" class="px-4 py-3 sm:px-6 text-center text-gray-500 dark:text-gray-400">Tidak ada data instrumen untuk Unit Kerja ini.</td></tr>`;
                } else {
                    let
