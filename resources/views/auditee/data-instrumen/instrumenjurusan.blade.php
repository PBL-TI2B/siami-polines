        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const renderTable = (page = 1) => {
                ...
                if (paginatedData.length === 0) {
                    tableBody.innerHTML = `<tr><td colspan="9" class="px-4 py-3 sm:px-6 text-center text-gray-500 dark:text-gray-400">Tidak ada data instrumen untuk jurusan ini.</td></tr>`;
                } else {
