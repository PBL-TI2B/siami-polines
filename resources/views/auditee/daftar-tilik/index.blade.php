                ...
                <table id="tilik-table" class="min-w-full text-left text-sm text-gray-500 dark:text-gray-400">
                    <thead class="border-b border-t border-gray-200 bg-gray-50 text-xs uppercase text-gray-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="border-r border-gray-200 px-4 py-3 sm:px-6 dark:border-gray-600">Realisasi</th>
                            <th scope="col" class="border-r border-gray-200 px-4 py-3 sm:px-6 dark:border-gray-600">Standar Nasional / Polines</th>
                            <th scope="col" class="border-r border-gray-200 px-4 py-3 sm:px-6 dark:border-gray-600">Uraian Isian</th>
                            <th scope="col" class="border-r border-gray-200 px-4 py-3 sm:px-6 dark:border-gray-600">Akar Penyebab (Target tidak tercapai)/ Akar Penunjang (Target tercapai)</th>
                            <th scope="col" class="border-r border-gray-200 px-4 py-3 sm:px-6 dark:border-gray-600">Rencana Perbaikan & Tindak Lanjut</th>
    ...
    <div id="deleteConfirmModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 hidden">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button id="confirmDeleteBtn" type="button" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition-all duration-200">
                    Ya, Hapus Response
                </button>
            </div>
        </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const showToast = (message, isSuccess = true) => {
            ...
            modalIcon.innerHTML = isSuccess
                ...
                <span class="sr-only">Ikon Sukses</span>`
                :/NewLine/ `<svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                fetch(`http://127.0.0.1:5000/api/response-tilik/${currentResponseTilikId}`, {
                    ...
                    .then(result => {
                        ...
                        if (result.success) {
                            ...
                            showToast('Gagal menghapus response: ' + (result.message || 'Unknown error'), false);
                        }
                        currentResponseTilikId = null;
                    })
                    .catch(error => {
                ...
                fetch(`http://127.0.0.1:5000/api/auditings/${auditingId}`, {
                    ...
                    .then(result => {
                        ...
                        if (result.success || result.message === 'Data auditing berhasil diperbarui') {
                            ...
                            showToast('Gagal mengunci jawaban: ' + (result.message || 'Unknown error'), false);
                        }
                    })
                    .catch(error => {
