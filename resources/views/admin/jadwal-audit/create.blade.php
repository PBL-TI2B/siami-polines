...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('jadwal-audit.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="unit_kerja" name="unit_kerja_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white">
                ...
                <!-- Periode AMI
                <div>
                    <label for="periode_ami" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Periode AMI</label>
    ...
    @endforeach
                ...
                <div>
                    ...
                    <select id="auditee_1" name="user_id_1_auditee" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select id="auditor_1" name="user_id_1_auditor" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select id="auditee_2" name="user_id_2_auditee" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select id="auditor_2" name="user_id_2_auditor" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('jadwal-audit.index') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-white rounded-md shadow hover:bg-gray-300">Batal</a>
                <button type="submit" class="px-4 py-2 bg-sky-800 text-white rounded-md shadow hover:bg-sky-700">Simpan</button>
            </div>
        </form>
    </div>
@endsection