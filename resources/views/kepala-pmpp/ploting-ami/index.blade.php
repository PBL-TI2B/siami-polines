            ...
            @forelse ($auditings as $index => $auditing)
                <tr
                    ...
                    <td class="border border-gray-200 px-4 py-4 text-center">
                        <span
                            class="inline-flex rounded-full px-3 py-1 text-xs font-semibold bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-300 min-w-[80px] justify-center">
                ...
                <div id="response-modal"
                    ...
                    <div
                        class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 pb-6 dark:bg-gray-800">
                        ...
                        <h1 class="mb-4 text-center font-semibold text-gray-700 dark:text-gray-300">RTM (Rapat tinjauan
                            Manajemen)</h1>
                        ...
                        <form id="response-form">
                            ...
                            <div class="mt-6 flex justify-center gap-2">
                                <x-button id="cancel-btn" type="button" color="gray"
                                    class="px-4 py-2 text-sm font-medium">
                                    Batal
                                </x-button>
                                <x-button type="submit" id="submit-btn" color="sky"
                                    class="px-4 py-2 text-sm font-medium">
                                    Selesai
                                </x-button>
                            </div>
